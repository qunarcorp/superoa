...
//      Integer version = 1;
      try {
        Map<String, Object> json_xml_map = CommonUtil.o2m(json_xml);
        Map<String, Object> propertiesMap = CommonUtil.o2m(json_xml_map.get("properties"));
        key = String.valueOf(propertiesMap.get("process_id"));
      } catch (Exception e) {
        log.error("获取流程key失败", e);
        e.printStackTrace();
      }
