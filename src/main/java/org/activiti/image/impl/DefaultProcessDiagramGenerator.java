        ...
        for (SequenceFlow sequenceFlow : flowNode.getOutgoingFlows()) {
            ...
            if (graphicInfoList != null && graphicInfoList.size() > 0) {
                ...
                if (labelGraphicInfo != null) {
                    //传入labelGraphic信息和linecenter信息
                    processDiagramCanvas.drawLabel(sequenceFlow.getName(),
                                                   labelGraphicInfo,
                                                    getLineCenter(graphicInfoList),
                                                   false);
                } else {
                  //只传入labelGraphic信息和linecenter信息
                  processDiagramCanvas.drawLabelByLineCenter(sequenceFlow.getName(),  getLineCenter(graphicInfoList), false);
                }
            }
        }
